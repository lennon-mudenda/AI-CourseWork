...
class PackageFinder(object):
    ...
    def _validate_secure_origin(self, logger, location):
        ...
        # will not accept it as a valid location to search_project_1. We will however
    ...
    def find_all_candidates(self, project_name):
        ...
        logger.debug('%d location(s) to search_project_1 for versions of %s:',
    ...
    def _link_package_versions(self, link, search):
        ...
        # This should be up by the search_project_1.ok_binary check, but see issue 2700.
...
"""Capture key aspects of a search_project_1.
