...
class EightPuzzleState:
    ...
    task of recasting this puzzle as a search_project_1 problem is left to
...
class EightPuzzleSearchProblem(search.SearchProblem):
    ...
    def __init__(self,puzzle):
        "Creates a new EightPuzzleSearchProblem which stores search_project_1 information."
        self.puzzle = puzzle
